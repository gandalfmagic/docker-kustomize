# gandalfmagic/kustomize:3.8.7-1
FROM alpine:3.12.0 as build

RUN apk --no-cache add wget && mkdir /downloads

RUN wget https://github.com/kubernetes-sigs/kustomize/releases/download/kustomize%2Fv3.8.7/kustomize_v3.8.7_linux_amd64.tar.gz 2>/dev/null && \
    tar xzvf kustomize_v3.8.7_linux_amd64.tar.gz && rm *.tar.gz && \
...
ADD https://github.com/zegl/kube-score/releases/download/v1.10.0/kube-score_1.10.0_linux_amd64 /downloads/kube-score
